...
<div className="items-center justify-center flex">
              <button
                className="border-2 border-white bg-white dark:bg-[#231212] dark:text-white hover:bg-[#422727] dark:hover:bg-gray-800  hover:text-white text-black p-2 px-4 m-2 rounded text-sm w-full md:w-auto"
                type="submit"
              >
                Register
              </button>
