    ...
    <div className="dark:text-white dark:bg-black font-mono">
      ...
      <div className="flex justify-between items-center bg-[#231212] dark:bg-black text-white p-6 shadow-md">
        <div className="flex gap-y-2">
          <div>
            <h2 className="text-5xl font-bold">Glass Cleaning</h2>
      ...
      <div className="flex p-4">
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Window glass cleaning (interior & exterior)</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Glass door cleaning and polishing</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Mirror cleaning and streak removal</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Balcony glass railings cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Glass table and shelf cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Stain and spot removal on glass</div>
          </div>
        </div>
        ...
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Commercial building glass cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>High-rise window cleaning (above 3 floors)</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Broken glass repair or replacement</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Specialized glass coating services</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Window frame cleaning and repair</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Tinted glass cleaning services</div>
          </div>
        </div>
      </div>
    </div>
