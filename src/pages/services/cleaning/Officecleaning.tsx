import officeImg from "/Fixify_images/office-cleaning.png";
    ...
    <div className="dark:text-white dark:bg-black font-mono">
      ...
      <div className="flex justify-between items-center bg-[#231212] dark:bg-black text-white p-6 shadow-md">
        <div className="flex gap-y-2">
          <div>
            <h2 className="text-5xl font-bold">Office Cleaning</h2>
      ...
      <div className="flex p-4">
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Desk and workstation dusting</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Floor sweeping and mopping</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Restroom and toilet cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Conference room and furniture cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Trash removal and recycling</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Kitchen and breakroom area cleaning</div>
          </div>
        </div>
        ...
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Carpet shampooing or deep cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Window and glass cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Upholstery and chair cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Wall cleaning and stain removal</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Post-renovation cleaning</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Specialized sanitization services</div>
          </div>
        </div>
      </div>
    </div>
