    ...
    <div className="dark:text-white dark:bg-black font-mono">
      ...
      <div className="flex justify-between items-center bg-[#231212] dark:bg-black text-white p-6 shadow-md">
        <div className="flex gap-y-2">
          <div>
            <h2 className="text-5xl font-bold">Drain Unclogging</h2>
      ...
      <div className="flex p-4">
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Drain pipe inspection and diagnosis</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Manual drain cleaning with tools</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Chemical drain cleaning treatment</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Removal of debris and blockage</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Water flow testing and verification</div>
          </div>
        ...
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Pipe replacement or installation</div>
          </div>
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Video drain inspection</div>
          </div>
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Trench digging for pipes</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Septic tank maintenance</div>
          </div>
        </div>
      </div>
    </div>
...
export default Drainunclogging;
