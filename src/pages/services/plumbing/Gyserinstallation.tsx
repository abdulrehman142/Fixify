    ...
    <div className="dark:text-white dark:bg-black font-mono">
      ...
      <div className="flex justify-between items-center bg-[#231212] dark:bg-black text-white p-6 shadow-md">
        <div className="flex gap-y-2">
          <div>
            <h2 className="text-5xl font-bold">Gyser Installation</h2>
      ...
      <div className="flex p-4">
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Water heater installation and setup</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Pipe connections and plumbing work</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Electrical connections and wiring</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Safety valve and pressure gauge installation</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>Water testing and temperature adjustment</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={yesImg} className="h-8 w-8" />
            <div>User manual and instructions provided</div>
          </div>
        </div>
        ...
        <div className="p-4 m-4">
          ...
          <div className="flex items-center gap-2 p-2 m-2">
            ...
            <div>Water heater supply and purchase</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Wall mounting or bracket installation</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Maintenance and annual servicing</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Warranty coverage for heater</div>
          </div>

          <div className="flex items-center gap-2 p-2 m-2">
            <img src={noImg} className="h-8 w-8" />
            <div>Old heater removal or disposal</div>
          </div>
...
export default Gyserinstallation;
