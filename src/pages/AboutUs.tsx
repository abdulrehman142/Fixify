    ...
    <div className="font-sans leading-relaxed">
      ...
      <div className="p-6 dark:bg-black dark:text-white">
        ...
        <p className="mb-4 leading-relaxed">
          Fixify is Pakistan’s leading on-demand home and personal services
          platform, connecting customers with skilled, verified technicians in a
          fast, safe, and hassle-free way. Through our modern website, Fixify
          App, and Fixify Partner App, we make it easier for people to book
          trusted services and for technicians to find stable work
          opportunities.
        </p>

        <p className="mb-4 leading-relaxed">
          Our mission is simple: <strong>make daily life easier</strong> for
          customers and empower local service providers to grow.
        </p>
        ...
        <p className="mb-4 leading-relaxed">
          Our consumer platform is built to simplify the life of every
          household. With just a few taps, customers can book anything from home
          repairs to cleaning to personal grooming services. Every service comes
          with:
        </p>
        ...
        <p className="mb-4 leading-relaxed">
          To uplift and empower technicians, Fixify registers service providers
          through the Fixify Partner App. Each partner completes:
        </p>
        ...
        <p className="mb-4 leading-relaxed">
          Fixify aims to support thousands of technicians across Pakistan by
          providing them consistent earning opportunities. With guidance from
          our support team and through strict SOPs, technicians deliver an
          excellent customer experience and earn with dignity and reliability.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Our Achievements</h2>
        <p className="mb-4 leading-relaxed">
          Fixify has grown rapidly into a trusted nationwide platform. Our
          expansion and user adoption reflect our commitment to quality.
        </p>
        ...
        <p className="mb-4 leading-relaxed">
          Starting from Lahore, Fixify now operates in:
        </p>
      ...
      <div className="flex justify-between p-6 dark:bg-black bg-white">
        <div className="flex flex-col items-center w-70 h-70 bg-[#f4f4f5] rounded-2xl">
          ...
          <div className="text-center text-[#94a2b3] p-4">
            Our service providers are verified, monitored, and evaluated for
            each service provided to guarantee our satisfaction.
          </div>
        </div>
        <div className="flex flex-col items-center w-70 h-70 bg-[#f4f4f5] rounded-2xl">
          <div className="mt-4">
          ...
          <div className="text-center text-[#94a2b3] p-4">
            Our customer service is at your disposal seven days a week, and we ensure responsiveness from order taking to service delivery.
          </div>
        </div>
        <div className="flex flex-col items-center w-70 h-70 bg-[#f4f4f5] rounded-2xl">
          <div className="mt-4">
          ...
          <div className="text-center text-[#94a2b3] p-4">
            Our verified, highly skilled, and experienced technicians will reassure the quality of service to win your trust.
          </div>
        </div>
        <div className="flex flex-col items-center w-70 h-70 bg-[#f4f4f5] rounded-2xl">
          <div className="mt-4">
          ...
          <div className="text-center text-[#94a2b3] p-4">
            Fixify promises remarkable services at competitive market rates: no hidden charges or over-charged bills.
          </div>
        </div>
