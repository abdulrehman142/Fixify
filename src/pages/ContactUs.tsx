  ...
  return (
    <div className="dark:text-white dark:bg-black font-sans">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="bg-[#231212] dark:bg-black border-2 border-[#231212] dark:border-[#231212] rounded-lg shadow p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-2 rounded bg-white dark:bg-[#231212] text-black dark:text-white min-h-[140px] focus:outline-none"
