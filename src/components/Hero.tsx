...
const Hero = () => {
  ...
  const allServices = [
    ...
    { name: "Breaker Repair/Installation", route: "/circuit-breaker-repair-installation", image: circuitBreakerImg },
    { name: "Generator Repair/Installation", route: "/generator-repair-installation", image: generatorImg },
    ...
    { name: "Switchboard Repair/Installation", route: "/switchboard-repair-installation", image: switchImg },
    // Plumbing
    ...
    { name: "Toilet Repair Installation", route: "/toilet-repair-installation", image: toiletrepairImg },
    // Mechanical
    ...
    { name: "Wooden Flooring Repair/Installation", route: "/wooden-flooring", image: woodenflooringImg },
  ...
  const filteredServices = search.trim() === "" ? [] : allServices.filter(service =>
    ...
    return (
      <div className="relative w-full">
        ...
        {showSuggestions && filteredServices.length > 0 && (
          <div className={`flex flex-col shadow-lg rounded-md p-2 border-2 absolute top-full left-0 right-0 mt-1 z-50 max-h-64 overflow-y-auto bg-[#231212] dark:bg-black border-[#231212] dark:border-[#231212]`}>
            {filteredServices.slice(0, 8).map((service, idx) => (
              ...
              >
                <img src={service.image} alt={service.name} className="w-6 h-6 object-cover rounded" loading="lazy" />
  ...
  const handleSend = () => {
    if (search.trim() !== "") {
      const selectedService = allServices.find(s => 
