...
const Fanrepairinstallation = lazy(() => import("./pages/services/electricianing/Fanrepairinstallation"));
const Circuitbreakerrepairinstallation = lazy(() => import("./pages/services/electricianing/Circuitbreakerrepairinstallation"));
const Generatorrepairinstallation = lazy(() => import("./pages/services/electricianing/Generatorrepairinstallation"));
const Socketrepairinstallation = lazy(() => import("./pages/services/electricianing/Socketrepairinstallation"));
const Lightrepairinstallation = lazy(() => import("./pages/services/electricianing/Lightrepairinstallation"));
const Wiringrewiring = lazy(() => import("./pages/services/electricianing/Wiringrewiring"));
const Switchboardrepairinstallation = lazy(() => import("./pages/services/electricianing/Switchboardrepairinstallation"));
...
const Bathroomfittingsinstallation = lazy(() => import("./pages/services/plumbing/Bathroomfittingsinstallation"));
const Sinkrepair = lazy(() => import("./pages/services/plumbing/Sinkrepair"));
const Toiletrepairinstallation = lazy(() => import("./pages/services/plumbing/Toiletrepairinstallation"));
const Technician= lazy(() => import("./pages/services/technicianing/Technician"));
const Acinstallationrepair = lazy(() => import("./pages/services/technicianing/Acinstallationrepair"));
const Refrigeratorrepair = lazy(() => import("./pages/services/technicianing/Refrigeratorrepair"));
const Washingmachinerepair = lazy(() => import("./pages/services/technicianing/Washingmachinerepair"));
...
const Tvrepairinstallation = lazy(() => import("./pages/services/technicianing/Tvrepairinstallation"));
        ...
        <Layout darkMode={darkMode} setDarkMode={setDarkMode}>
          <Suspense fallback={<LoadingSpinner />}>
            <Routes>
              ...
              <Route path="/circuit-breaker-repair-installation" element={<Circuitbreakerrepairinstallation />} />
              <Route path="/generator-repair-installation" element={<Generatorrepairinstallation />} />
              ...
              <Route path="/switchboard-repair-installation" element={<Switchboardrepairinstallation />} />
              ...
              <Route path="/bathroom-fittings-installation" element={<Bathroomfittingsinstallation />} />
